...
// Fetch data from nama_barang table
...
if(isset($_POST['submit'])){
    ...
    // Insert new data into nama_barang table
...
if(isset($_GET['delete_id'])){
    ...
    // Delete data from datamaster table
    $query = "DELETE FROM datamaster WHERE id = ?";
            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form" enctype="multipart/form-data">
                        ...
                        <!-- Move the closing div tags here to enclose the entire form -->
                        <div class="card-content">
                            <div class=" card-body">
                                <button type="submit" name="submit" class="btn icon icon-left btn-primary me-1 mb-1" id="tambah">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn icon btn-danger aksi-buttons" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal<?php echo $result["id"]; ?>">
                ...
                <!-- Modal -->
                <div class="modal fade" id="confirmDeleteModal<?php echo $result["id"]; ?>" tabindex="-1" aria-labelledby="confirmDeleteModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                Are you sure you want to delete "<?php echo $result["namabarang"]; ?>"?
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                <a href="namaBarang.php?delete_id=<?php echo $result["id"]; ?>" class="btn btn-danger">Delete</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<footer>
    ...
    function confirmDelete(namabarang, page) {
        if (confirm("Are you sure you want to delete " + namabarang + "?")) {
            window.location.href = page + "?delete_id=" + namabarang;
        }
    }
</script>
