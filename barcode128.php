<?php 
// Your existing code for generating barcode
...
// Create barcode image function
function generateBarcodeImage($text) {
    $barcodeHTML = bar128($text);
    // Create a new image
    ...
    // Add barcode HTML text to the image
    imagettftext($img, 12, 0, 10, 20, $textColor, 'arial.ttf', $barcodeHTML);
...
// Call the function to generate barcode image and get the file path
